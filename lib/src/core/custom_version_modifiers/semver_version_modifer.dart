...
/// Class with helper methods to bump SEMVER version
class MagicalSEMVER {
  static Version _parseVersion(String version) => Version.parse(version);
  ...
  static ({bool buildHadIssues, String version}) bumpVersion(
    String version, {
