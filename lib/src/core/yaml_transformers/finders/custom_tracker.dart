...
/// Custom counter that increments using [MatchedNodeData].
/// 
/// See [Counter].
final class MatchCounter extends Counter<dynamic> {
  ...
  bool incrementUsingMatch(MatchedNodeData data) {
    ...
    final anyBelowLimit = _limit == null ||
        super.counterstate.values.toSet().any(
              (element) => element < _limit!,
            );
